...
<head>
    ...
    <meta name="description" content="Photobooth Studio - Upload foto dan cetak di booth kami">
...
<body>
    <nav class="navbar">
        <a href="{{ route('frame.select') }}" class="navbar-brand"><i class="ph ph-camera"></i> Momentum</a>
    </nav>
